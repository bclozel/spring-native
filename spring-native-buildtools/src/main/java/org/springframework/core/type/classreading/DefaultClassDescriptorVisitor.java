...
class DefaultClassDescriptorVisitor extends ClassVisitor {
	...
	public void visitEnd() {
		String className = this.className.replace(INNER_CLASS_SEPARATOR, CLASS_SEPARATOR);
		this.metadata = new DefaultClassDescriptor(this.typeSystem, className, this.access,
